      ...
      <div className="w-full max-w-md space-y-6 rounded-lg border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="flex justify-between items-start">
          <div className="space-y-2 text-center flex-1">
            <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Crear cuenta demo</h1>
            <p className="text-sm text-slate-600 dark:text-slate-300">Registrate como inquilino para probar la app.</p>
          </div>
          <div className="ml-4">
            <ThemeToggle />
          </div>
